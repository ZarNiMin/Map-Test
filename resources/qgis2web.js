...
map.getView().fit([9070296.679522, 1008953.837072, 12757349.047042, 3468990.417461], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Testing Map</h2>';
        return titleElement;
    })(),
...
var searchLayer = new SearchLayer({
    layer: lyr_mmr_polbnda2_adm1_mimu_250k_1,
    colName: 'ST_PCODE',
    zoom: 10,
    collapsed: true,
    map: map
